...
window.startApp          = require('issueboard/tests/helpers/start_app')['default'];
window.isolatedContainer = require('issueboard/tests/helpers/isolated_container')['default'];
